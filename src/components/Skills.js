        ...
        <div className="p-10">
            ...
            <div className="flex flex-wrap mt-2">
                ...
                {webDevelopment.map((webDevelopment) => (
                    <span className="m-2 bg-blue-100 text-blue-800 text-sm font-semibold px-4 py-2 rounded-full" key={webDevelopment}>
            {webDevelopment}
          </span>
                ))}
            </div>
            <div className="flex flex-wrap mt-2">
                ...
                {dataScience.map((dataScience) => (
                    <span className="m-2 bg-blue-100 text-blue-800 text-sm font-semibold px-4 py-2 rounded-full" key={dataScience}>
            {dataScience}
          </span>
                ))}
            </div>
            <div className="flex flex-wrap mt-2">
                ...
                {ai.map((ai) => (
                    <span className="m-2 bg-blue-100 text-blue-800 text-sm font-semibold px-4 py-2 rounded-full" key={ai}>
            {ai}
          </span>
                ))}
            </div>
